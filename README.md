...
`POSITION_ACTION_PRIORITY_V2`：既有部位先看重大事件／基本面硬風險，再看價格技術結構，最後才看法人籌碼。法人分歧不能單獨把價格仍站在20／60日EMA之上的股票判成「降低部位」；漲停或強勢確認且無硬風險時，逐檔顯示「正常持有／續抱、不追價」，並把籌碼分歧列為觀察。價格結構破壞且法人同步轉弱，或硬風險成立，才進入減碼；新部位門檻不放寬。<!-- POSITION_ACTION_PRIORITY_V2 -->
