...
function renderPositions(){
  ...
  if(!tracked.length){positionRows.innerHTML='<tr><td class="position-empty" colspan="9"><b>尚未標記任何布局部位。</b><br>請在前三名、前30名或完整排名中勾選「追蹤」；之後不論重跑多少次，該股票都會留在這裡並套用最新判斷。</td></tr>';return}
