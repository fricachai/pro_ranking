...
<style>
/* Keep the decision-card reading order intact as the browser narrows. */
...
@media (min-width:761px) and (max-width:1180px){
  .position-card{grid-template-columns:minmax(180px,.85fr) minmax(180px,.95fr) minmax(260px,1.6fr);grid-template-areas:"stock action trigger" "stock reasons trigger";align-items:stretch}
  .position-card>section:nth-child(1){grid-area:stock}
  .position-card>section:nth-child(2){grid-area:action}
  .position-card>section:nth-child(3){grid-area:trigger}
  .position-card>section:nth-child(4){grid-area:reasons;align-self:start;padding-top:14px;border-top:1px solid var(--line)}
  .position-card .position-trigger-pane{padding-left:18px;border-left:1px solid var(--line);border-top:0}
  .position-card .position-reasons-pane{padding-left:18px;border-left:1px solid var(--line)}
}
@media (min-width:761px) and (max-width:900px){
  .position-card{grid-template-columns:minmax(180px,.8fr) minmax(0,1.5fr);grid-template-areas:"stock action" "stock trigger" "stock reasons";gap:0 18px}
  .position-card .position-trigger-pane,.position-card .position-reasons-pane{padding-top:14px;border-top:1px solid var(--line)}
}
@media (max-width:760px){
  .position-card .position-action-pane,.position-card .position-trigger-pane,.position-card .position-reasons-pane{min-width:0}
